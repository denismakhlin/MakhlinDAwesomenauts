		...
		me.game.world.addChild(new me.Sprite(0, 0, me.loader.getImage('background')), -10); // TODO
                ...
                me.game.world.addChild(new (me.Renderable.extend({
                    ...
                    draw: function(render){
                        ...
                        this.font.draw(render.getContext(), "F2: ADD STARTING GOLD ", this.pos.x, this.pos.y + 150);
                        this.font.draw(render.getContext(), "F3: INCREASE ATTACK DAMAGE ", this.pos.x, this.pos.y + 200);
                        this.font.draw(render.getContext(), "F4: INCREASE STARTING HEALTH ", this.pos.x, this.pos.y + 250);
                    }
                })));
